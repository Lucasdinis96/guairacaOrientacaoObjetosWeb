            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white dark:bg-gray-800">
                    ...
                    <form action="{{ route('professors.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="registro" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                Registro:
                            </label>
                    ...
                    <button action="{{ route('professors.index') }}" class="bg-yellow-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Voltar
                    </button>
                </div>
            </div>
