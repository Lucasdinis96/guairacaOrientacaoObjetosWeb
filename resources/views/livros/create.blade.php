        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white dark:bg-gray-800">
                ...
                <form action="{{ route('livros.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="editora" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            Editora:
                        </label>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="year" name="ano_publicacao" id="ano_publicacao" class="form-input mt-1 block w-full" required>
                    </div>
